...
def save_mask_data(tags_chinese, mask_list, box_list, label_list):
...
def ram_json(model, image_path, ram_model, predictor):
    ...
    return save_mask_data(tags, masks, boxes_filt, pred_phrases)
